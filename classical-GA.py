...
##Classical genetic algorithm. Never goes past phase 0. Will have 4 layers from the get go, since in the previous case, changes in phase were adding additional layers up to a maximum of 4. No variable length chromosome usage present.
